...
course_description = "This interactive ebook was created by a ITiCSE working group to test the effects of solving Parsons problems with and without distractors. "
